...
<head>
    ...
    <title>
        @yield('title', 'Admin Panel - Web SMKN 11')
    </title>
    ...
    <!-- Boxicons -->
    <link rel="stylesheet"
          href="{{ asset('sneat/assets/vendor/fonts/boxicons.css') }}">

    <!-- Sneat CSS -->
    <link rel="stylesheet"
          href="{{ asset('sneat/assets/vendor/css/core.css') }}">

    <link rel="stylesheet"
          href="{{ asset('sneat/assets/vendor/css/theme-default.css') }}">

    <link rel="stylesheet"
          href="{{ asset('sneat/assets/css/demo.css') }}">
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu"
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item
                        {{ request()->routeIs('admin.profiles.*') ? 'active' : '' }}">
                    ...
                    <li class="menu-item
                        {{ request()->routeIs('admin.jurusans.*') ? 'active' : '' }}">
                    ...
                    <li class="menu-item
                        {{ request()->routeIs('admin.pengumuman.*') ? 'active' : '' }}">
